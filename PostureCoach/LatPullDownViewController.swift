//
//  LatPullDownViewController.swift
//  PostureCoach
//
//  Created by Youn on 2023/10/05.
//

import UIKit

class LatPullDownViewController: UIViewController {
...
extension LatPullDownViewController: GameStateChangeObserver {
    func gameManagerDidEnter(state: GameManager.State, from previousState: GameManager.State?) {
        ...
        case is GameManager.SetupCameraState:
